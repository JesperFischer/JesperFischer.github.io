...
- [Overview](#overview)
- [Non Gaussian Marginals](#non-gaussian-marginals)
- [Simulation and fitting](#simulation-and-fitting)
...
![](/images/Bayesian-Workflow-Tutorials/2025-02-02-Continous-copulas_files/figure-markdown_strict/unnamed-chunk-3-1.png)
...
![](/images/Bayesian-Workflow-Tutorials/2025-02-02-Continous-copulas_files/figure-markdown_strict/unnamed-chunk-6-1.png)
...
-   The Simulations above are not conditional on experimentally
    manipulated variables. Thus in order for this to be useful 
    we need to show that we can recover parameters from the 
    marginal distributions that are conditional on experimentally 
    manipulated variables (X).
